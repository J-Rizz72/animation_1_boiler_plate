...
# canvas variables
width = 1240 # adjust for width of canvas
height = 975 # adjust for height of canvas
...
pygame.display.set_caption("Nemo") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("Nemo.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 15 # code the number of sprite images your sprite sheet has
